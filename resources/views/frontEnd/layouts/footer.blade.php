<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © Jide Ogundumade Inc. All rights reserved.</p>
                <p class="pull-right">Designed by <span><a target="_blank" href="https//:github.com/Jogundumade">Jide</a></span></p>
            </div>
        </div>
    </div>
</footer><!--/Footer-->